window.BOOKS_MANIFEST = [
  {
    ...
    summary_en:
      "James Clear shows that real change happens less through willpower and more through simple structures that reduce friction for the desired habit.",
  ...
  },
  {
    ...
    summary_en:
      "Cal Newport argues that deep work has become rare and extremely valuable.",
  ...
  },
  {
    ...
    summary_en:
      "Greg McKeown argues that real productivity comes from the discipline of saying no.",
  ...
  },
  {
    ...
    summary_en:
      "Duhigg shows how habits form and persist through a simple loop.",
  ...
  },
  {
    ...
    summary_en:
      "Carol Dweck connects how we think about talent and effort with human development.",
  ...
  },
  {
    ...
    summary_en:
      "Csikszentmihalyi studies the deeply absorbing state in which a person feels fully engaged.",
  ...
  },
  {
    ...
    category_en: "Psychology",
    hook_en:
      "Even at the extreme edge of pain, inner meaning can be preserved.",
    summary_en:
      "Frankl explains how the search for meaning sustains inner freedom even in extreme suffering.",
  ...
  },
  {
    ...
    summary_en:
      "Sinek shows how leaders and brands gain power when they start from a clear why.",
  ...
  },
  {
    ...
    summary_en:
      "Martin gathers practical principles for writing software that is readable, sustainable and easy to maintain.",
  ...
  },
  {
    ...
    summary_en:
      "Aristotle describes ethical life as the virtuous balance between excess and deficiency and how character is formed through practice.",
  ...
  },
  {
    ...
    category_en: "Technology",
    hook_en:
      "Quality is built in every sprint, not only at the end of the project.",
    summary_en:
      "The approach shows QA and development working together from the start.",
  ...
  },
  {
    ...
    category_en: "Technology",
    hook_en:
      "Perfect software is not the absence of defects, but a strategy of excellence.",
    summary_en:
      "Perfect software depends on processes, discipline and systems thinking.",
