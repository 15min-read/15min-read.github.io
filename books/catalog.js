window.BOOKS_MANIFEST = [
  ...
  {
    slug: "homem-em-busca-significado",
    file: "homem-em-busca-significado.md",
    title: "Em Busca de Significado",
    author: "Viktor Frankl",
    year: 1946,
    category: "Filosofia",
    minutes: 15,
    hook: "Entre o estímulo e a resposta há um espaço — nele mora nossa liberdade.",
    summary: "Frankl transforma sofrimento em uma reflexão profunda sobre liberdade interior e sentido.",
    tags: ["sentido", "sofrimento", "liberdade"]
  },
  {
  ...
  },
  {
    ...
    category: "Tecnologia",
    minutes: 15,
    hook: "Sistemas resilientes são projetados para falhar com elegância.",
    summary: "O livro ensina a pensar em resiliência, falhas em cascata e operações seguras.",
    tags: ["resiliência", "sistemas", "ops"]
  },
  {
    slug: "site-reliability",
    file: "site-reliability.md",
    title: "Site Reliability Engineering",
    author: "Google SRE Team",
    year: 2016,
    category: "Tecnologia",
    minutes: 15,
    hook: "Confiabilidade é uma responsabilidade operacional e cultural.",
    summary: "O livro conecta engenharia, observabilidade e práticas de operação de sistemas modernos.",
    tags: ["sre", "observabilidade", "operações"]
  },
  {
    slug: "working-effectively",
    file: "working-effectively.md",
    title: "Working Effectively with Legacy Code",
    author: "Michael C. Feathers",
    year: 2004,
    category: "Tecnologia",
    minutes: 15,
    hook: "Legacy code exige coragem, testes e pequenas mudanças planejadas.",
    summary: "O livro oferece estratégias práticas para trabalhar com código antigo sem perder controle.",
    tags: ["legacy", "testes", "refatoração"]
  },
  {
    slug: "jeito-pragmatico",
    file: "jeito-pragmatico.md",
    title: "O Jeito Pragmático",
    author: "Andrew Hunt & David Thomas",
    year: 1999,
    category: "Tecnologia",
    minutes: 15,
    hook: "Boas práticas vêm de princípios, não de dogmas.",
    summary: "O livro reúne uma filosofia prática de software orientada por valores e decisões úteis.",
    tags: ["pragmatismo", "software", "prática"]
  },
  {
    slug: "pensamentos-rapido-lento",
    file: "pensamentos-rapido-lento.md",
    title: "Pensamentos Rápido e Devagar",
    author: "Daniel Kahneman",
    year: 2011,
    category: "Psicologia",
    minutes: 15,
    hook: "O cérebro opera com dois sistemas de pensamento, e isso muda tudo.",
    summary: "Kahneman mostra como heurísticas, vieses e decisões rápidas moldam a vida cotidiana.",
    tags: ["decisão", "viés", "psicologia"]
  }
];
